...
(cl:defmethod cl:initialize-instance :after ((m <DriveWithDistance-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveWithDistance-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-srv:<DriveWithDistance-request> is deprecated: use morelab_robot_platform-srv:DriveWithDistance-request instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <DriveWithDistance-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morelab_robot_platform-srv:distance-val is deprecated.  Use morelab_robot_platform-srv:distance instead.")
  (distance m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveWithDistance-request>)))
  ...
  "morelab_robot_platform/DriveWithDistanceRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveWithDistance-request)))
  "Returns string type for a service object of type 'DriveWithDistance-request"
  "morelab_robot_platform/DriveWithDistanceRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <DriveWithDistance-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DriveWithDistance-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-srv:<DriveWithDistance-response> is deprecated: use morelab_robot_platform-srv:DriveWithDistance-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DriveWithDistance-response>)))
  ...
  "morelab_robot_platform/DriveWithDistanceResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveWithDistance-response)))
  "Returns string type for a service object of type 'DriveWithDistance-response"
  "morelab_robot_platform/DriveWithDistanceResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DriveWithDistance)))
  ...
  "morelab_robot_platform/DriveWithDistance")