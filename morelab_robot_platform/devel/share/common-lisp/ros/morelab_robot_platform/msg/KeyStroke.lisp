...
(cl:defmethod cl:initialize-instance :after ((m <KeyStroke>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KeyStroke)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-msg:<KeyStroke> is deprecated: use morelab_robot_platform-msg:KeyStroke instead.")))

(cl:ensure-generic-function 'keycode-val :lambda-list '(m))
(cl:defmethod keycode-val ((m <KeyStroke>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morelab_robot_platform-msg:keycode-val is deprecated.  Use morelab_robot_platform-msg:keycode instead.")
  (keycode m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<KeyStroke>)))
  ...
  "morelab_robot_platform/KeyStroke")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'KeyStroke)))
  "Returns string type for a message object of type 'KeyStroke"
  "morelab_robot_platform/KeyStroke")
