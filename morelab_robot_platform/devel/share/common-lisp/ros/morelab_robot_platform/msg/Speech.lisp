...
(cl:defmethod cl:initialize-instance :after ((m <Speech>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Speech)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-msg:<Speech> is deprecated: use morelab_robot_platform-msg:Speech instead.")))

(cl:ensure-generic-function 'text-val :lambda-list '(m))
(cl:defmethod text-val ((m <Speech>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader morelab_robot_platform-msg:text-val is deprecated.  Use morelab_robot_platform-msg:text instead.")
  (text m))
