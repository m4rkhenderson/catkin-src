...
(cl:defmethod cl:initialize-instance :after ((m <ADC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ADC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-msg:<ADC> is deprecated: use morelab_robot_platform-msg:ADC instead.")))
