...
(cl:defmethod cl:initialize-instance :after ((m <Ping>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Ping)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name morelab_robot_platform-msg:<Ping> is deprecated: use morelab_robot_platform-msg:Ping instead.")))
